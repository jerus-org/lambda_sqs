...
- deps: update dependency toolkit to v8(pr [#161])
- deps: lock file maintenance(pr [#158])
- deps: update rust crate lambda_runtime to 1.4.0(pr [#160])
...
- deps: lock file maintenance(pr [#148])
- deps: update serde packages(pr [#149])
- deps: update rust crate lambda_runtime to 1.3.0(pr [#151])
- deps: update rust crate tokio to 1.53.1(pr [#152])
- deps: lock file maintenance(pr [#154])
- deps: update dependency toolkit to v7(pr [#155])
...
- deps: update actions/checkout action to v7(pr [#146])
- deps: update fossa-contrib/fossa-action action to v4(pr [#147])
...
- remove jq from tools verification(pr [#138])
...
- deps: update rust crate tokio to 1.50.0(pr [#132])
...
- deps: update rust crate tokio to 1.49.0(pr [#127])

## [0.2.37] - 2025-11-28

### Fixed

- deps: update rust crate lambda_runtime to v1(pr [#120])
- deps: update dependency toolkit to v2.16.0(pr [#118])
- deps: update actions/checkout action to v6(pr [#119])

## [0.2.36] - 2025-10-28

### Fixed

- deps: update dependency toolkit to v2.13.5(pr [#115])
- deps: update rust crate serde to 1.0.228(pr [#116])
- deps: update rust crate tokio to 1.48.0(pr [#117])
...
- deps: update serde packages(pr [#114])
...
[#148]: https://github.com/jerus-org/lambda_sqs/pull/148
[#149]: https://github.com/jerus-org/lambda_sqs/pull/149
[#151]: https://github.com/jerus-org/lambda_sqs/pull/151
[#152]: https://github.com/jerus-org/lambda_sqs/pull/152
...
[#161]: https://github.com/jerus-org/lambda_sqs/pull/161
[#158]: https://github.com/jerus-org/lambda_sqs/pull/158
[#160]: https://github.com/jerus-org/lambda_sqs/pull/160
[0.3.6]: https://github.com/jerus-org/lambda_sqs/compare/v0.3.5...v0.3.6
